...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.17/bit-0.1.17-macos-aarch64.tar.xz"
      sha256 "73cf3b652a3aebd07a5cbf9dd9a287431c58213afb39e8a179d2a2f8c35cb13c"
    end
    on_intel do
