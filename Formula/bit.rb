...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.8/bit-0.1.8-macos-aarch64.tar.xz"
      sha256 "6316c4be4af186700c4da83e75f77063ccf701159147c134b11450d810c4eac9"
    end
    on_intel do
