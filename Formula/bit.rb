...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.6.0/bit-0.6.0-macos-aarch64.tar.xz"
      sha256 "f2a8d8e401b3de456ca2832ea6fc46b772e7e85d95ed6c772a57cb8fc082d952"
    end
    on_intel do
