...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.26.1/bit-0.26.1-macos-aarch64.tar.xz"
      sha256 "869769ed8327e52febcb65db6a0df4acc8595eff125502bfaa6f5ac7a2231f57"
    end
    on_intel do
