...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.25/bit-0.1.25-macos-aarch64.tar.xz"
      sha256 "906e833ab714e1d218639736749a9e3403cf7df74afdf682cbfa80796f1216bb"
    end
    on_intel do
