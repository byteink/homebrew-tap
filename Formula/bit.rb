...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.12.0/bit-0.12.0-macos-aarch64.tar.xz"
      sha256 "7e085abf68201d91f3f62fb4c93edff02a489f619ce2cddb76653d68c51c2a93"
    end
    on_intel do
