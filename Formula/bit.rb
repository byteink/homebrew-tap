...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.19/bit-0.1.19-macos-aarch64.tar.xz"
      sha256 "aba537367b522c12965fea756272847f916c97dd57804de163bee1e7625c62a8"
    end
    on_intel do
