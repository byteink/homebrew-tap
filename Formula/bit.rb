...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.27/bit-0.1.27-macos-aarch64.tar.xz"
      sha256 "1fc582ed460c361abd984e4544fcd65ddfc82080472b630bf92d30150afa703a"
    end
    on_intel do
