...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.26.0/bit-0.26.0-macos-aarch64.tar.xz"
      sha256 "9196b350c8a66da4d734a47f36db8b740da58edb391bae0ffc89c618833aaec7"
    end
    on_intel do
