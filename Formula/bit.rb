...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.28/bit-0.1.28-macos-aarch64.tar.xz"
      sha256 "872663aca96b2389faf14908e2ebffa38eff76c447a9ee29977e09ecd7ae8f8b"
    end
    on_intel do
