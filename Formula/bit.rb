...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.10.0/bit-0.10.0-macos-aarch64.tar.xz"
      sha256 "ee830568da71cd10209ca63f522ca2a71da374d35970c7fde044537a26e4dd92"
    end
    on_intel do
