...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.4.0/bit-0.4.0-macos-aarch64.tar.xz"
      sha256 "e2998f6c8b217eb822ba10416c1a28be4fbea9de3c3679f693e2d5dbdfa6fe45"
    end
    on_intel do
