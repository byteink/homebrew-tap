...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.24/bit-0.1.24-macos-aarch64.tar.xz"
      sha256 "3351be004753497dce2ff510e2d2a097254aa4b09f133fbeec4db84cc9256973"
    end
    on_intel do
