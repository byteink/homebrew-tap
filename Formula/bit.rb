...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.21.0/bit-0.21.0-macos-aarch64.tar.xz"
      sha256 "75a03544a95200a060f57eec0eccba8e77d513668ad318ce3d1e7178fb63fb1f"
    end
    on_intel do
