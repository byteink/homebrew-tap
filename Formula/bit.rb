...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.11.0/bit-0.11.0-macos-aarch64.tar.xz"
      sha256 "63dc9d62c99c5222591f0e1f130ef706b3d74b98de599ddf3120ec3168d471d7"
    end
    on_intel do
