...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.20/bit-0.1.20-macos-aarch64.tar.xz"
      sha256 "7c64a7aef838ea4f0bf35791a3ae47c4babab6c489414a027707e58f5a38f439"
    end
    on_intel do
