...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.10/bit-0.1.10-macos-aarch64.tar.xz"
      sha256 "7da708bec7a56a39c6779c61c1e70b22d88718cb248ac162e957cf978d22e309"
    end
    on_intel do
