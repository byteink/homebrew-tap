...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.6/bit-0.1.6-macos-aarch64.tar.xz"
      sha256 "5d886696f65cdc5a4bed3f1f9e27ffefd36022623cc01bafa4e2676c9a5682ca"
    end
    on_intel do
