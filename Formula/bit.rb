...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.25.0/bit-0.25.0-macos-aarch64.tar.xz"
      sha256 "bb2be98774e59d302bedf9ff3db14f71e4da44a009d5e7194a1e917d68e407ea"
    end
    on_intel do
