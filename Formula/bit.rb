...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.16/bit-0.1.16-macos-aarch64.tar.xz"
      sha256 "22f2482c64a029efbc1fb0984b2ed337e0ee6dba39e16fc52d986d3a0f9e559f"
    end
    on_intel do
