...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.13/bit-0.1.13-macos-aarch64.tar.xz"
      sha256 "afd83eccd11bc9a31ad9ded524337c68f0e60b48017f153b35f0c040b449dc95"
    end
    on_intel do
