...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.5.0/bit-0.5.0-macos-aarch64.tar.xz"
      sha256 "a0684ba56e95d93b1c4b9f498bf9d9ccb13817d0a820c642f5682c368d80f5c0"
    end
    on_intel do
