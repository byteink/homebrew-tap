...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.17.0/bit-0.17.0-macos-aarch64.tar.xz"
      sha256 "6dbe060c014bf20c74f5c3ed47dae1a85f728a99f4a31cfcc8689278fa609df1"
    end
    on_intel do
