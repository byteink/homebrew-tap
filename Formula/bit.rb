...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.18/bit-0.1.18-macos-aarch64.tar.xz"
      sha256 "f81043dee805ab4f3cc4bc005b395b5863e5d2ffc36114e3e670b2ab61aeedb9"
    end
    on_intel do
