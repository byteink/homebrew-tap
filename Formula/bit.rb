...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.22.0/bit-0.22.0-macos-aarch64.tar.xz"
      sha256 "f23ee19efbeb361c14c5ed39fe166ad152997e45358cd861b9e8d74b7157e1da"
    end
    on_intel do
