...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.3.0/bit-0.3.0-macos-aarch64.tar.xz"
      sha256 "46acc734a4c84cd526380bc4fef7a793a85eb14298f7051d4de331955b314ba0"
    end
    on_intel do
