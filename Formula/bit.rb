...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.24.0/bit-0.24.0-macos-aarch64.tar.xz"
      sha256 "539c643a4ff3961d99802f78e9bdedf738f7979f09b5c0e691c206a787ebc616"
    end
    on_intel do
