...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.5/bit-0.1.5-macos-aarch64.tar.xz"
      sha256 "a422766fb3a45df16cff7851f083540dd13fbf1e3458a5edd741cfa12085bae8"
    end
    on_intel do
