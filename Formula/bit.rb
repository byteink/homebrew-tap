...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.23.0/bit-0.23.0-macos-aarch64.tar.xz"
      sha256 "6ace5fb6c41a2a21bf4238bca69fd747f8bc61796a8e35271c011e89281bbf62"
    end
    on_intel do
