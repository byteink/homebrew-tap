...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.21.1/bit-0.21.1-macos-aarch64.tar.xz"
      sha256 "bc16e12f702bb4680155b084f8e7beb6f519b46a3a17ea2acfdee5b428e64f97"
    end
    on_intel do
