...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.21/bit-0.1.21-macos-aarch64.tar.xz"
      sha256 "1fc706f879f6b1aa0dd68abf9335e5a1678c9dcdb3dff0cc02ce4cfc3113685a"
    end
    on_intel do
