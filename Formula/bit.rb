...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.4.1/bit-0.4.1-macos-aarch64.tar.xz"
      sha256 "dc363e8e12cc1489c88a789321d05271346d00759c3caa9db973ecb068d0d6a5"
    end
    on_intel do
