...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.13.0/bit-0.13.0-macos-aarch64.tar.xz"
      sha256 "ababa139b66be3c5b4cdbdbe885f543a3ed72ed42d07f861292818b38c6781e6"
    end
    on_intel do
