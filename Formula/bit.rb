...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.23/bit-0.1.23-macos-aarch64.tar.xz"
      sha256 "b91e7f271a1f502373a7a67dcda47a5f51d02cd93f5ba964e1455b6a1099d7a0"
    end
    on_intel do
