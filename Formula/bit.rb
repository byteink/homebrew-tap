...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.18.0/bit-0.18.0-macos-aarch64.tar.xz"
      sha256 "4cdd712c96bf2581c0370007c1039e9f9c4085f1ef1bd4dd068f44df64be95ee"
    end
    on_intel do
