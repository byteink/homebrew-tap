...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.11/bit-0.1.11-macos-aarch64.tar.xz"
      sha256 "c3f68fac63f61d30ee271a193c06cf8a4e3d5cbd569df53b240a8fce3abe4052"
    end
    on_intel do
