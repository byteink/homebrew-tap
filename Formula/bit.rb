...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.7.0/bit-0.7.0-macos-aarch64.tar.xz"
      sha256 "3d903fb8f6991f25f7ee4d898f6297c004f1537abef0a2e39120de0a4bd5fcb9"
    end
    on_intel do
