...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.20.0/bit-0.20.0-macos-aarch64.tar.xz"
      sha256 "b924e3a3af8184b66b5d0fad967fffcdfd60d0169318f871f1363c5cbf8be39b"
    end
    on_intel do
