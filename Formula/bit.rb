...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.27.0/bit-0.27.0-macos-aarch64.tar.xz"
      sha256 "b7431c1dc8550716b17ab754843c8d2e43fc73b7fc9c10485d39a78c54623d0d"
    end
    on_intel do
