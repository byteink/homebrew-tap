...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.12/bit-0.1.12-macos-aarch64.tar.xz"
      sha256 "7a56a4cd230a6b6de35b9abdfa37eecde34dfc6a979fe5700dbfd31b5ff0d58d"
    end
    on_intel do
