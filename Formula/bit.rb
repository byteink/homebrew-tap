...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.22/bit-0.1.22-macos-aarch64.tar.xz"
      sha256 "f52d6eda4a4d9f4d694763bddbc3d6f654d4806603563fb6f376ca4255d8c6ee"
    end
    on_intel do
