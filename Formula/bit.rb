...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.7/bit-0.1.7-macos-aarch64.tar.xz"
      sha256 "1023bf8ef9d0aa07a76c4bf6477290d02af1216ed10e30286b79e3794ac8022c"
    end
    on_intel do
