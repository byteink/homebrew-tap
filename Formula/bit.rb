...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.15/bit-0.1.15-macos-aarch64.tar.xz"
      sha256 "7c3ea24b48084017ea5dd95cb9569323c40b865ee0e920bcd9055fb85252e147"
    end
    on_intel do
