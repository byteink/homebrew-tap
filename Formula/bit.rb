...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.19.0/bit-0.19.0-macos-aarch64.tar.xz"
      sha256 "0f64d29b817226e8d9729ca4b73f5f20fe236eff049ee63f9f548cceda1dd13f"
    end
    on_intel do
