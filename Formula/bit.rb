...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.2.0/bit-0.2.0-macos-aarch64.tar.xz"
      sha256 "bf3ba9938ac8787842d7015d9f2cbdff82318635f47318ccd76310ce41956a00"
    end
    on_intel do
