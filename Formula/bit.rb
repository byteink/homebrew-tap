...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.4.2/bit-0.4.2-macos-aarch64.tar.xz"
      sha256 "b840ea116720d3a133c33b103acc04d4b8d340bf8694919c8272d07c4ae5243d"
    end
    on_intel do
