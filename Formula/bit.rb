...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.26/bit-0.1.26-macos-aarch64.tar.xz"
      sha256 "186a8e236ccc42cff57f8522e4f37b9d46599212b15b132fa0d2d0524138fc16"
    end
    on_intel do
