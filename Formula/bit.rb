...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.9/bit-0.1.9-macos-aarch64.tar.xz"
      sha256 "5f2c1e310ad7a6fdc9e5fbd2d1d5fd7f7019b5b12f0933dde83361e058162e98"
    end
    on_intel do
