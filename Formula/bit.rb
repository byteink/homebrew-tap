...
class Bit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/byteink/bit/releases/download/v0.1.14/bit-0.1.14-macos-aarch64.tar.xz"
      sha256 "ad82356f905b6ea1bd4be1d36e961990fc2b7bcf43026a719b231c96a78be9f1"
    end
    on_intel do
